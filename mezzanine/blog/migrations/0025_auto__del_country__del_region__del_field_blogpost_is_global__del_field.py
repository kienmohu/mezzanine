...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'BlogPost.is_global'
        db.delete_column('blog_blogpost', 'is_global')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'BlogPost.is_global'
        db.add_column('blog_blogpost', 'is_global',
    ...
    models = {
        ...
        'blog.blogpost': {
            ...
            'alternative_title': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
