...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('blog_country', 'region_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['blog.Region'], null=True))

    def backwards(self, orm):

        # Changing field 'Country.region'
        db.alter_column('blog_country', 'region_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['blog.Region']))
    ...
    models = {
        ...
        'blog.country': {
            ...
            'region': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['blog.Region']", 'null': 'True', 'blank': 'True'})
        },
        'blog.region': {
