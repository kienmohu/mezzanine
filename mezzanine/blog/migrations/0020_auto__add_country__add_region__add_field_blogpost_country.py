...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('blog_country', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=80)),
            ('region', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['blog.Region'])),
        ))
        db.send_create_signal('blog', ['Country'])

        # Adding model 'Region'
        db.create_table('blog_region', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal('blog', ['Region'])

        # Adding field 'BlogPost.country'
        db.add_column('blog_blogpost', 'country',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['blog.Country'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Country'
        db.delete_table('blog_country')

        # Deleting model 'Region'
        db.delete_table('blog_region')

        # Deleting field 'BlogPost.country'
        db.delete_column('blog_blogpost', 'country_id')
    ...
    models = {
        ...
        'blog.blogcategory': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'project_section': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
        ...
        'blog.blogpost': {
            ...
            'country': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['blog.Country']", 'null': 'True', 'blank': 'True'}),
        ...
        'blog.country': {
            ...
            'region': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['blog.Region']"})
        },
        'blog.region': {
