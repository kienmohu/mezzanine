...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BlogPost.content_model'
        db.add_column('blog_blogpost', 'content_model',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True),
                      keep_default=False)

        if not db.dry_run:
            # Save the models so they generate the correct content_model field
            # value.
            from procor.posts.models import ProjectPost, BlogPost,\
                    ArticlePost, Newsletter, EventPost
    ...
    def backwards(self, orm):
        # Deleting field 'BlogPost.content_model'
        db.delete_column('blog_blogpost', 'content_model')
