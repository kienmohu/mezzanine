...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BlogCategory.project_section'
        db.add_column('blog_blogcategory', 'project_section',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BlogCategory.project_section'
        db.delete_column('blog_blogcategory', 'project_section')
